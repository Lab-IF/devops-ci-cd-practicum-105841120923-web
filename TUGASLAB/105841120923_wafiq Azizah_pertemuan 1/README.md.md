...
|----|------------|------------|
| 1 | ![Git Version](screenshots/01-git-version.png.png) | Output git --version |
| 2 | ![Git Config](screenshots/02-git-config.png.png) | Output git config --list |
| 3 | ![Docker Version](screenshots/03-docker-version.png.png) | Output docker --version |
| 4 | ![Docker Hello World](screenshots/04-docker-hello-world.png.png) | Output docker run hello-world |
| 5 | ![VS Code](screenshots/05-vscode-extensions.png.png) | VS Code dengan extensions |
