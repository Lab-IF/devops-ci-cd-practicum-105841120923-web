...
Saya berharap praktikum DevOps ini membantu saya memahami alur pengembangan software modern secara lebih nyata, bukan hanya teori. Saya ingin mengerti bagaimana proses dari menulis kode sampai aplikasi bisa dijalankan dan dideploy dengan benar. Selain itu, saya berharap bisa lebih terbiasa menggunakan tools seperti Git dan Docker serta memahami pentingnya kerja sama tim dalam pengembangan aplikasi.

### Skill yang Ingin Dikuasai

Di akhir semester, saya ingin lebih mahir menggunakan Git (branching dan merge), memahami cara membuat dan menjalankan container dengan Docker, serta mengetahui dasar CI/CD.

### Tantangan yang Dihadapi

Tantangan saya yaitu pas awal kurang mengerti harus mulai dari mana tapi alhamdulillah bisa saya mengerjakan praktikum ini karena sudah dipelajari sebelumnya 
